...
class HomeFragment : Fragment() {
    ...
    class ElectricPowerUnit(
        val efficiencyFactor: Double, // Coefficient of efficiency.
        val loadFactor: Double,       // Coefficient of nominal power.
        val nominalPower: Double,     // Nominal voltage.
        val unitCount: Double,        // Quantity of EPs.
        val actualPower: Double,      // Nominal power of the EP.
        val variationCoefficient: Double, // Coefficient of load variation.
        val reactivePowerCoefficient: Double // Coefficient of reactive power.
    ) {
        var rs1rivn: Double = 0.0 // Variable to store calculated value, initialized later.
    }

    class EPStorage(
        val nomPotEp: Double, // Nominal power of ElectricPowerUnit.
        val koefVik: Double,  // Coefficient of usage.
        val koefReakPot: Double // Coefficient of reactive power.
    ) {
        var groupKVik: Double = 0.0 // Group coefficient of load variation.
        var effCount: Double = 0.0 // Effective unit count of ElectricPowerUnits.
        val rozKAkP: Double = 1.25 // Coefficient of active power calculation.
        var rozAkNav: Double = 0.0 // Calculated active load.
        var sumKvNP: Double = 0.0 // Sum of product of coefficient of load variation and nominal power.
        var sumKvNPTg: Double = 0.0 // Sum of product of coefficient of load variation, nominal power, and reactive power coefficient.
        var rozReakNav: Double = 0.0 // Calculated reactive load.
        var povnPotu: Double = 0.0 // Full power.
        var rozGroupSt: Double = 0.0 // Calculated group current.
        var ForgroupKVik: Double = 0.0 // Intermediate value for groupKVik calculation.
        var ForeffCount: Double = 0.0 // Intermediate value for effCount calculation.
